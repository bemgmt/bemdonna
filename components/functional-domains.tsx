...
export default function FunctionalDomains() {
  ...
  return (
    <section id="capabilities" ref={ref} className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {domains.map((domain, index) => (
            ...
            >
              ...
              {/* Example (collapsed by default, could be expandable) */}
        ...
        <div className="text-center">
          <Link
            href="/#demo-form"
            className="inline-block px-8 py-3 rounded-lg bg-accent text-background hover:bg-accent/90 transition-all duration-300 font-semibold text-lg glow-accent hover:shadow-[0_0_30px_rgba(132,204,255,0.5)]"
          >
            See DONNA in Action
          </Link>
        </div>
